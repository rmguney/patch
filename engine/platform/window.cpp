...
namespace patch
{
    ...
    Window::Window(int32_t, int32_t, const char *title)
        : hwnd_(nullptr), hinstance_(GetModuleHandleA(nullptr)), width_(0), height_(0), resized_(false), should_close_(false), focused_(false), mouse_{0.0f, 0.0f, 0.0f, false, false}, keys_{false, false, false, false, false, false, false, false, false, false}
    {
    ...
    LRESULT Window::handle_message(HWND hwnd, UINT msg, WPARAM wparam, LPARAM lparam)
    {
        ...
        case WM_KILLFOCUS:
            ...
            keys_ = {false, false, false, false, false, false, false, false, false, false};
            ReleaseCapture();
            return 0;
        ...
        case WM_MOUSEWHEEL:
        {
            const float steps = (float)GET_WHEEL_DELTA_WPARAM(wparam) / (float)WHEEL_DELTA;
            mouse_.wheel_delta += steps;
            return 0;
        }
    ...
    bool Window::key_pressed(int key_code) const
    {
