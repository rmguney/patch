...
#define profile_get_frequency() platform_get_frequency()
    ...
    typedef enum
    {
        ...
        PROFILE_RENDER_GBUFFER,
        PROFILE_RENDER_OBJECTS,
...
#define PROFILE_DRAW_VOLUME PROFILE_RENDER_UI_OVERLAY
#define PROFILE_RAY_RENDER PROFILE_RENDER_UI_OVERLAY
...
static inline float profile_get_avg_ms(int cat)
{
    (void)cat;
    return 0.0f;
}
static inline float profile_get_max_ms(int cat)
{
    (void)cat;
    return 0.0f;
}
static inline float profile_get_min_ms(int cat)
{
    (void)cat;
    return 0.0f;
}
static inline float profile_get_last_ms(int cat)
{
    (void)cat;
    return 0.0f;
}
static inline float profile_get_p50_ms(int cat)
{
    (void)cat;
    return 0.0f;
}
static inline float profile_get_p95_ms(int cat)
{
    (void)cat;
    return 0.0f;
}
static inline float profile_get_p99_ms(int cat)
{
    (void)cat;
    return 0.0f;
}
static inline const char *profile_get_name(int cat)
{
    (void)cat;
    return "";
}
static inline int32_t profile_get_sample_count(int cat)
{
    (void)cat;
    return 0;
}
