...
const int32_t g_material_count = 23;

_Static_assert(MAT_ROSE + 1 == 23, "Material count must match g_material_count");
_Static_assert(MAT_ROSE < MATERIAL_MAX_COUNT, "Material ID exceeds table size");
