...
const int32_t g_material_count = 24;

_Static_assert(MAT_ORANGE + 1 == 24, "Material count must match g_material_count");
_Static_assert(MAT_ORANGE < MATERIAL_MAX_COUNT, "Material ID exceeds table size");
